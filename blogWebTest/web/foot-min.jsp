...
<div  id="foot" class="foot-1">
    <div id="foot1" class="foot1-1">
        <ul id="foot2" class="foot2-2">
            ...
            <li><a href="mailto:webmaster@csdn.net" target="_blank"><img src="img/email.png" alt style="height: 16px" width="16px">kefu@csdn.net</a></li>
            <li><a href="https://csdn.s2.udesk.cn/im_client/?web_plugin_id=29181" target="_blank"><img src="img/cs.png" alt style="height: 16px" width="16px">在线客服</a></li>

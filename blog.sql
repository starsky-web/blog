...
-- Records of articles
-- ----------------------------
INSERT INTO `articles` VALUES (27, 2, 'EL', 'EL.md', 23, 0, '2020-12-04 22:24:37', 0, 'EL表达式 概念Exeio Laguage 作用替换和简化j页面中java代码的编写 语法${表达式} 注意j默认支持EL表达式，要忽略的话在age指令里加上iELIgoed=\"tue\"或者在$前加 \\  使用方式 运算 运算符1、算数运算');
INSERT INTO `articles` VALUES (28, 2, '这里是文章标题', '这里是文章标题.md', 13, 0, '2020-12-04 22:31:25', 0, '这里是edito的内');
INSERT INTO `articles` VALUES (30, 2, 'sdsd', 'sdsd.md', 1, 0, '2020-12-07 13:57:34', 0, NULL);
INSERT INTO `articles` VALUES (31, 2, 'test', 'test.md', 3, 0, '2020-12-07 13:58:29', 0, '这里是edito的内');
INSERT INTO `articles` VALUES (32, 3, '01、安装', '01、安装.md', 59, 0, '2020-12-07 19:31:46', 9, '1、安装------ 1、java安装java的安装不难，跟着提示下一步就好。但是安装完以后要配置环境变量，以下给大家说一下如何配置环境变量右击此电脑---属性---高级系统设置---环境变量在下面的系统变量处新建一个变量，名字是JAVA_');
...
INSERT INTO `articles` VALUES (75, 29, '30、过滤器', '30、过滤器.md', 1, 0, '2020-12-10 19:59:31', 0, '30、过滤器------ 1、概述过滤器是用来定义文件查找中过滤方法的接口在File中有两个和LitFile重载的方法，传递的是过滤器 2、方法File[] litFile(FileFilte filte)方法接受一个过滤器，并按过滤器的定');
...
INSERT INTO `articles` VALUES (100, 32, '10、MySQL变量', '10、MySQL变量.md', 1, 0, '2020-12-10 20:28:22', 0, '10、MySQL变量------ 1、系统变量变量由系统提供，不是用户定义，属于服务器层面**使用语法**1、查看所有的系统变量qlhow gloal vaiale-- 参看所有全局变量how eio vaiale-- 查看所有会话变量，可');
...
INSERT INTO `articles` VALUES (118, 29, '【python游戏编程之旅】第九篇---嗷大喵快跑小游戏开发实例', '【python游戏编程之旅】第九篇---嗷大喵快跑小游戏开发实例.md', 0, 0, '2020-12-12 23:21:34', 0, '本系列博客介绍以ytho+ygame库进行小游戏的开发。有写的不对之处还望各位海涵。前几期博客我们一起学习了，ygame中的a hef=\"htt://www.clog.com/mxh//5027688.html\" taget=\"_lak\"冲');
...
INSERT INTO `articles` VALUES (123, 29, 'Unity3D游戏开发初探—4.开发一个“疯狂击箱子”游戏', 'Unity3D游戏开发初探—4.开发一个“疯狂击箱子”游戏.md', 0, 0, '2020-12-12 23:25:49', 0, '一、预备知识—对象的”生“与”死“　　（1）如何在游戏脚本程序中创建对象而不是一开始就创建好对象？-使用GameOject的静态方法：**CeatePimitive()****　　**以上一篇的博文中的“指哪打哪”例子为基础，在AddFoc');
...
INSERT INTO `articles` VALUES (131, 29, '运维工程师主要工作是做什么？', '运维工程师主要工作是做什么？.md', 0, 0, '2020-12-12 23:32:52', 0, '总结两句话：1、保障业务长期稳定运行（如网站服务器、游戏服务器等）。2、保障数据安全可靠（如用户名密码、游戏数据、博客文章、交易数据等）。由这两句话推演运维工程师要学些什么？一、保障业务长期稳定运行出一点点差错，用户就要投诉了。1、业务跑在');
...
INSERT INTO `articles` VALUES (138, 29, '解读5G标准：5G频率范围与频段', '解读5G标准：5G频率范围与频段.md', 0, 0, '2020-12-12 23:37:29', 0, 'a hef=\"htt://log.cd.et/ZhogGuoReMei/aticle/detail/103639795\"htt://log.cd.et/ZhogGuoReMei/aticle/detail/103639795/a以5G波段为');
...
INSERT INTO `articles` VALUES (142, 29, 'android音视频点直播模块开发', 'android音视频点直播模块开发.md', 0, 0, '2020-12-12 23:40:10', 0, 'lael音视频 /lael版权声明：本文为博主原创文章，未经博主允许不得转载。 前言随着音视频领域的火热，在很多领域（教育，游戏，娱乐，体育，跑步，餐饮，音乐等）尝试做音视频直播/点播功能，那么作为开发一个小白，如何快速学习音视频基础知识，');
...
INSERT INTO `articles` VALUES (144, 29, 'yun2win即时通讯云', 'yun2win即时通讯云.md', 1, 0, '2020-12-12 23:41:14', 0, 'yu2wi官网：a hef=\"htt://www.yu2wi.com\" taget=\"_lak\"www.yu2wi.com/aSDK下载地址：a hef=\"htt://www.yu2wi.com/h-col-107.html\" taget=');
...
INSERT INTO `articles` VALUES (148, 29, '百人研发团队的难题：研发管理、绩效考核、组织文化和OKR', '百人研发团队的难题：研发管理、绩效考核、组织文化和OKR.md', 0, 0, '2020-12-12 23:50:40', 0, 'lockquote分享一个公司规模近200，研发占一半的创业公司 Woktile 在研发团队管理方面的玩法，仅供百人左右研发团队参考~/lockquote什么是研发团队？简单的说，你熟悉的那帮穿格子衬衫，以程序员为核心组成的团队，就是研发团');
...
INSERT INTO `articles` VALUES (150, 29, '大型信息化建设标准基础数据管理平台【商业版，铜墙铁壁】', '大型信息化建设标准基础数据管理平台【商业版，铜墙铁壁】.md', 0, 0, '2020-12-12 23:51:28', 0, '大概在3年前，我们集团公司杭州分公司刚刚成立，那时候公司的招聘还不够规范，没有独立的人力资源部，其实到现在为止也没有确切的人力资源部，公司并不是几千人，上万人的大公司，由办公室来统一管理招聘工作，办公室的招聘工作流程大致是这样的。1：网上发');
INSERT INTO `articles` VALUES (151, 29, '几个软件研发团队管理的小问题', '几个软件研发团队管理的小问题.md', 0, 0, '2020-12-12 23:52:04', 0, '最近在与一位总经理交流的时候，他谈到他们公司的软件研发管理，说：“我们公司最大的问题是项目不能按时完成，总要一拖再拖。”他问我有什么办法能改变这个境况。从这样一个问题开始，在随后的交谈中，又引出他一连串在软件研发管理中的遇到的问题，包括：*');
INSERT INTO `articles` VALUES (152, 29, '绩效，历练与成长---研发管理的天平', '绩效，历练与成长---研发管理的天平.md', 0, 0, '2020-12-12 23:52:26', 0, '　　曾经有个新入职的小伙伴问我这么一个问题：“老大，像我这样的菜鸟，是不是还有很多东西要学？感觉现在压力好大，每个方面都缺好多，学不过来”。　　我只回了他两个字：“淡定！”　　这是每个研发团队都会面临的难题，当一个新人并不具备足够的工作能力');
INSERT INTO `articles` VALUES (153, 29, '研发管理：与员工一对一交流的执行与反思', '研发管理：与员工一对一交流的执行与反思.md', 0, 0, '2020-12-12 23:52:51', 0, '一对一交流的想法来源两篇文章：《a hef=\"htt://www.36k.com//151617.html\"与员工一对一交流：企业经营必行之道/a》，《a hef=\"htt://www.36k.com//148857.html\"你知道我今天');
...
INSERT INTO `articles` VALUES (155, 29, '程序开发与信息安全工具箱', '程序开发与信息安全工具箱.md', 1, 0, '2020-12-12 23:54:41', 0, '程序开发与信息安全工具箱a ame=\"FHML\"/a 索引- a hef=\"SECA\"A/a、a hef=\"SECB\"B/a、a hef=\"SECC\"C/a、a hef=\"SECD\"D/a、a hef=\"SECE\"E/a、a hef=\"SE');
...
INSERT INTO `articles` VALUES (157, 29, '给信息安全专业学生的书单', '给信息安全专业学生的书单.md', 0, 0, '2020-12-12 23:56:00', 0, '给信息安全专业学生的书单对我来说,读书是最重要的一项娱乐活动。我基本上是保持一周读一本书的节奏，这里的a hef=\"htt://ook.doua.com/eole/ocflytoky/collect\" taget=\"_lak\"读书列表/a记');
...
INSERT INTO `articles` VALUES (161, 29, '信息安全实习生面试小结', '信息安全实习生面试小结.md', 0, 0, '2020-12-12 23:59:06', 0, '**0x00前言**第一次面试没有经验，第一个面试电话接到的时候手都在抖2333，但到面试了几个公司后，也渐渐放得开了许多今年9月份就步入大四，因此再4月份时候也参加过几家公司的安全类的实习生的面试，其中有甲方公司，也有乙方公司。实习是找到');
...
INSERT INTO `articles` VALUES (164, 29, 'Oracle顶级认证OCM考试实战总结', 'Oracle顶级认证OCM考试实战总结.md', 0, 0, '2020-12-13 00:00:36', 0, 'OCM是Oacle认证体系中最顶级的证书和技能考试，通过后将成为企业内的资深专家，IT认证考试资源网应广大考生的要求制作了一个OCM考试实战总结，就是为了广大Oacle考生了解神秘的OCM考试流程和大致考点内容，以期更好地有针对性的学习相关');
INSERT INTO `articles` VALUES (165, 29, 'RPA流程自动化-Blueprism认证考试介绍', 'RPA流程自动化-Blueprism认证考试介绍.md', 0, 0, '2020-12-13 00:01:02', 0, '**RPA流程自动化-Blueim认证考试介绍**接触RPA有一段时间了，几种RPA相关工具也都试用过，BluePim是RPA工具的一种，今天跟大家分享考Blueim的一些经验。RPA(Root Poce Automatio)全称是机器人流');
...
INSERT INTO `articles` VALUES (169, 29, '15个nosql数据库', '15个nosql数据库.md', 1, 0, '2020-12-13 00:07:57', 0, '1、MogoDB**介绍**MogoDB是一个基于分布式文件存储的数据库。由C++语言编写。主要解决的是海量数据的访问效率问题，为WEB应用提供可扩展的高性能数据存储解决方案。当数据量达到50GB以上的时候，MogoDB的数据库访问速度是M');
...
INSERT INTO `articles` VALUES (172, 29, '创建数据库迁移', '创建数据库迁移.md', 1, 0, '2020-12-13 00:09:35', 0, '**a hef=\"htt://www.clog.com/fa//4849791.html\"返回总目录《一步一步使用ABP框架搭建正式项目系列教程》/a**h 这一节我们说说数据库迁移（Migatio）。我们之前用的DBFit创建了实体类，但');
...
INSERT INTO `articles` VALUES (175, 29, 'OpenStack云计算之路-Mitaka 版本', 'OpenStack云计算之路-Mitaka 版本.md', 1, 0, '2020-12-13 00:11:18', 0, '云计算简介云计算（英语：cloud comutig ），是一种基于互联网的计算方式，通过这种方式，共享的软硬件资源和信息可以按需求提供给计算机各种终端和其他设备。img c=\"htt://image2017.clog.com/log/119');
INSERT INTO `articles` VALUES (176, 29, 'SOA、ESB、NServiceBus、云计算 总结', 'SOA、ESB、NServiceBus、云计算 总结.md', 0, 0, '2020-12-13 00:11:40', 0, 'NSeviceBu doe, ad the achitectual imlicatio ae ofoud.）。  NSeviceBu 相对于 WCF 的优势在于：事件驱动的架构（发布、订阅）、更好地支持长时间运行的工作流。  缺点一：只支持');
INSERT INTO `articles` VALUES (177, 29, '博客园官方博客', '博客园官方博客.md', 0, 0, '2020-12-13 00:12:04', 0, 'a hef=\"htt://www.clog.com/cmt/tag/%E4%BA%91%E8%AE%A1%E7%AE%97/\" taget=\"_lak\"云计算之路/a系列博文分享的是我们将网站从IDC机房迁移至云计算平台的实际经历，目前处于');
INSERT INTO `articles` VALUES (178, 29, '云计算-从基础到应用架构系列-云计算的概念', '云计算-从基础到应用架构系列-云计算的概念.md', 0, 0, '2020-12-13 00:12:29', 0, '开篇lockquote 本篇是主要讲述什么是云计算，并且讲述云计算相比之前的一些比较新兴的计算模式之间的区别，并且简单的分析下云计算相比这些传统的企业应用模式之间的优势及优缺点。由于本篇是云计算系列的开篇，可能概念性的内容相对来说多一些，我');
...
INSERT INTO `articles` VALUES (181, 29, '云计算资源分享与下载', '云计算资源分享与下载.md', 0, 0, '2020-12-13 00:13:40', 0, '摘要　　自从上一篇a hef=\"htt://www.clog.com/KightWaio/achive/2010/09/08/1821098.html\"实战第一个云程序/a之后，我就没有再发布云计算相关的文章，这些天重新整理了一下草稿箱，发');
INSERT INTO `articles` VALUES (182, 26, 'AI人工智能-Python实现人机对话', 'AI人工智能-Python实现人机对话.md', 0, 0, '2020-12-13 00:59:08', 0, '【前言】 　　AI　　在人工智能进展的如火如荼的今天，我们如果不尝试去接触新鲜事物，马上就要被世界淘汰啦~　　本文拟使用Pytho开发语言实现类似于WIdow平台的“小娜”，或者是IOS下的“Sii”。最终达到人机对话的效果。 【实现功能】');
...
INSERT INTO `articles` VALUES (184, 26, '你所未知的人工智能应用领域', '你所未知的人工智能应用领域.md', 0, 0, '2020-12-13 01:00:20', 0, 'lockquote简评：对有些人来说，人工智能和机器人技术的普及对我们的隐私、工作甚至人身安全构成了威胁，因为越来越多的任务不是由人脑，而是由「硅脑」来执行。然而，即便是最直言不讳的批评者，也不得不承认人工智能为人类带来的诸多潜在好处。/l');
...
INSERT INTO `articles` VALUES (186, 26, '人工智能的局限性', '人工智能的局限性.md', 0, 0, '2020-12-13 01:01:34', 0, '转自王垠博客中的一篇文章，非常喜欢这篇文章。转载到自己博客里来。 人工智能的局限性有人听说我想创业，给我提出了一些“忽悠”的办法。他们说，既然你是程序语言专家，而现在人工智能（AI）又非常热，那你其实可以搞一个“自动编程系统”，号称可以自动');
...
INSERT INTO `articles` VALUES (188, 26, '人工智能之机器学习常见算法', '人工智能之机器学习常见算法.md', 1, 0, '2020-12-13 01:02:45', 0, 'img c=\"htt://image2017.clog.com/log/1248689/201711/1248689-20171121164207040-89390405.g\" alt=\"\"摘要之前一直对机器学习很感兴趣,一直没时间去研究,');
INSERT INTO `articles` VALUES (189, 26, 'web移动开发最佳实践之html', 'web移动开发最佳实践之html.md', 0, 0, '2020-12-13 01:03:38', 0, '**一、前言**　　在目前的**移动应用开发**大潮下，使用**we技术**进行移动应用开发正变得越来越流行，它主要使用**html5、c3、j**等技术，在**跨平台性、可移植性**方面具有无可比拟的优势，特别适合开发**对性能要求不太高');
...
INSERT INTO `articles` VALUES (192, 26, '移动端页面开发的两种方式', '移动端页面开发的两种方式.md', 0, 0, '2020-12-13 01:05:38', 0, '之前一直做的是we端，换工作之后重心变成了移动端，尝试几次之后总结了两种移动端页面的开发模式，可以自适应各种屏幕大小。希望对大家有所帮助。\\(▔＾▔)/ 一、使用meta标签使网页宽度自适应手机屏幕ytho1 meta ame=\"viewo');
INSERT INTO `articles` VALUES (193, 26, '移动端页面开发流程', '移动端页面开发流程.md', 0, 0, '2020-12-13 01:06:11', 0, '移动端页面布局 一、移动端a分类 1、Native A原生a手机应用程序　　使用原生的语言开发的手机应用，Adoid系统用的是java，io系统用的是oject-C 2、Hyid A 混合型a手机应用程序　　混合使用原生的程序和html5页');
...
INSERT INTO `articles` VALUES (196, 26, '程序人生的四个象限和两条主线', '程序人生的四个象限和两条主线.md', 2, 0, '2020-12-13 01:10:09', 0, '转载之前读过的一篇好文章，收藏在这里，长读长新。原文 a hef=\"htt://ftqq.com/2013/12/codig-life/\"htt://ftqq.com/2013/12/codig-life//a 作者 a hef=\"htt:');
...
INSERT INTO `articles` VALUES (198, 26, '多彩的程序人生', '多彩的程序人生.md', 2, 0, '2020-12-13 01:12:07', 0, '常常想程序人生的问题，也常常在网上看程序人生相关的话题，但听大师讲程序人生，还是第一次。这位大师，就是侯捷。侯捷，两岸著名技术教育者，计算机图书作者、译者、书评人，著有《深入浅出MFC》、《多型与虚拟》、《STL源码剖析》、《无责任书评》三');
...
INSERT INTO `articles` VALUES (200, 26, '浅谈程序员的行业选择---程序人生', '浅谈程序员的行业选择---程序人生.md', 1, 0, '2020-12-13 01:14:17', 0, '引言　　本篇博文接着许久之前的一篇博文《a hef=\"htt://www.clog.com/zuoxiaolog//life15.html\" taget=\"_lak\"浅谈程序猿的职业规划，看你如何决定自己的未来吧。/a》，继续探讨一下程序员');
INSERT INTO `articles` VALUES (201, 26, '十年程序人生规划', '十年程序人生规划.md', 4, 0, '2020-12-13 01:14:48', 0, '一、人生格言　　不要被生活主宰，要自己主宰生活；　　学习代表过去，能力代表现在，努力代表未来；　　当要做某件事情的时候，请在心里问自己下面这些内容？　　　　（1）这方面知识有什么意义；　　　　（2）学习这方面的哪些知识；　　　　（3）多长时');
...
INSERT INTO `articles` VALUES (205, 28, '计算机基础之进制转换详解', '计算机基础之进制转换详解.md', 0, 0, '2020-12-13 01:17:59', 0, '　　　　进制转换是个老问题了，今天恰巧看见。我详细的去分析下它。留一笔吧　　　　二进制的范围是(0-1)， 不包含2　　　　八进制的范围是(0-7) ，不包含8　　　　十六进制的范围是(0-15) ，不包含16　　　 先讲十进制----二进');
...
INSERT INTO `articles` VALUES (211, 28, '超越Web，Javascript在物联网的应用', '超越Web，Javascript在物联网的应用.md', 0, 0, '2020-12-13 01:22:47', 0, '**引子**Patick Catazaiti 是一名We开发工程师，最近他在 a hef=\"htt://www.iteoit.com/\"iteoit/a 发表了《a hef=\"htt://www.iteoit.com/javacit-eyo');
INSERT INTO `articles` VALUES (212, 28, '物联网常见通信协议梳理', '物联网常见通信协议梳理.md', 0, 0, '2020-12-13 01:23:27', 0, '1 概述在上一篇文章《物联网常见通信协议与通讯协议梳理【上】-通讯协议》中，对物联网常用通信协议和通讯协议作了区分，并对通讯协议进行了分享；本文将对常用的通信协议进行剖析，重点面向市场上使用率较高的，且又不是诸如TCP/IP之类老生常谈的。');
...
INSERT INTO `articles` VALUES (217, 28, '前端UI框架小汇总', '前端UI框架小汇总.md', 0, 0, '2020-12-13 01:26:31', 0, '前言：　　近期，小弟根据GitHu、前端社区、掘金等平台对当前流行的前端UI框架的进行了小小的整理和汇总（：前端UI框架的应用是通过GitHu ta数，社区热度和使用范围等进行的粗略的汇总【不分先后】）。希望对寻找UI框架的小伙伴们提供点帮');
INSERT INTO `articles` VALUES (218, 28, '前端编码规范之JavaScript', '前端编码规范之JavaScript.md', 0, 0, '2020-12-13 01:26:56', 0, '　　上次浅谈了下a hef=\"htt://www.clog.com/hutkykig//c-ec.html\" taget=\"_lak\"关于CSS的编码规范/a，大部分童鞋持赞同意见，仍存在一些童鞋不太理解这些规范的意义。　　如果是个人或者小');
INSERT INTO `articles` VALUES (219, 28, '前端规范之css', '前端规范之css.md', 1, 0, '2020-12-13 01:27:34', 0, '　　\"字是门面书是屋\"，我们不会去手写代码，但是敲出来的代码要好看、有条理，这还必须得有一点约束~　　团队开发中，每个人的编码风格都不尽相同，有时候可能存在很大的差异，为了便于压缩组件对代码进行压缩以及书写样式的规范统一和美观，很有必要大家');
INSERT INTO `articles` VALUES (220, 28, '前端面试题目搜集', '前端面试题目搜集.md', 0, 0, '2020-12-13 01:27:58', 0, '最近读到一本与前端面试有关的书《a hef=\"htt://ook.doua.comuject/30324146/\" taget=\"_lak\"前端程序员面试笔试宝典/a》，里面的内容很多都是高频的面试题，在此推荐给各位网友。img c=\"ht');
...
INSERT INTO `articles` VALUES (222, 28, '我所理解的前端', '我所理解的前端.md', 1, 0, '2020-12-13 01:28:53', 0, '入坑前端到今天也将近两年半了,这两天突然想到了第一次面试时面试官的一个问题-------你怎样理解前端的工作?对于当时我一个小白而言完全是胡说一通,词不达意,搞得面试官一脸懵逼,现在想想那可能就叫尬聊吧……时隔两年在不断爬坑中对这个问题有了');
...
INSERT INTO `articles` VALUES (226, 28, '区块链笔记', '区块链笔记.md', 0, 0, '2020-12-13 01:31:46', 0, '广义和狭义的区块链广义来讲，区块链技术是利用块链式数据结构来验证与存储数据、利用分布式节点共识算法来生成和更新数据、利用密码学的方式保证数据传输和访问的安全、利用由自动化脚本代码组成的智能合约来编程和操作数据的一种全新的**分布式基础架构与');
...
INSERT INTO `articles` VALUES (228, 28, '区块链学习路线', '区块链学习路线.md', 0, 0, '2020-12-13 01:32:43', 0, 'tyle.1 { magi: 0 fot: 24x \"Helvetica Neue\" colo: ga(51, 51, 51, 1) -wekit-text-toke: 333333 }.2 { magi: 0 fot: 16x \"Helv');
INSERT INTO `articles` VALUES (229, 28, '通俗易懂的讲解区块链', '通俗易懂的讲解区块链.md', 1, 0, '2020-12-13 01:33:17', 0, '最近，区块链很火，刚刚在人大会上又火了一把。之所以如此，是因为区块链既是全新的技术方案、交易模式和商业逻辑，同时也是一种全新的制度机制。区块链的“网红效应”才刚刚开始。 本文的主要思想来自于区块链：即使技术方案，也是制度机制。我也是一个区块');
...
INSERT INTO `articles` VALUES (232, 28, '理解MySQL——架构与概念', '理解MySQL——架构与概念.md', 0, 0, '2020-12-13 01:34:58', 0, '写在前面：最早接触的MySQL是在三年前，那时候MySQL还是4.x版本，很多功能都不支持，比如，存储过程，视图，触发器，更别说分布式事务等复杂特性了。但从5.0(2005年10月)开始，MySQL渐渐步入企业级数据库的行列了；复制、集群、');
...
INSERT INTO `articles` VALUES (237, 28, '网站服务架构', '网站服务架构.md', 0, 0, '2020-12-13 01:37:34', 0, '服务器划分 对于访问量大的网站而言，将网站的各个部分拆分分别部署到不同服务器上是很有必要的。例如将图片和we站点分开。一般而言，在网站的整个服务器部署上分为如下几种类型： **文件服务器：**一般存储系统的相关图片和文件，给各个子系统提供统');
